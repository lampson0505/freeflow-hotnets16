...
Figure~\ref{fig:intro_exist} shows the network bandwidth and latency between
...
\begin{figure}[t!]
     ...
     \caption{Network latency, bandwidth and CPU overhead between containers compared with ordinary processes in a single bare-metal host. \harry{swap (a) and (b)}} 
